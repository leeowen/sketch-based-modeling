...
\end{center}
\end{figure}
More modeling examples are given in Figures \ref{fig:more_example_on_2opens}. Figure \ref{fig:more_example_on_2opens}(a) shows the four silhouette contours of a foot model in the front and side views. Figure \ref{fig:more_example_on_2opens}(b) depicts the 3D foot model created from the four silhouette contours. Figure \ref{fig:more_example_on_2opens}(c) shows the cross-section curves. Figures \ref{fig:more_example_on_2opens}(d) and \ref{fig:more_example_on_2opens}(e) give 3D neck model and torso model generated from the above method.\\
