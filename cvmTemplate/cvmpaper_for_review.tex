...
%\begin{subfigure}{0.32\linewidth}
%\centering
%\fbox{\includegraphics[height=0.5in]{./figure/mouth_contour_front.png}}\caption{front}\label{mouth_contour_front}
%\end{subfigure}
%\begin{subfigure}{0.33\linewidth}
%\centering
%\fbox{\includegraphics[height=0.5in]{./figure/mouth_contour_top.png}}\caption{top}\label{mouth_contour_top}
%\end{subfigure}
%\begin{subfigure}{0.32\linewidth}
%\centering
%\fbox{\includegraphics[height=0.5in]{./figure/mouth_contour_side.png}}\caption{side}\label{mouth_contour_side}
%\end{subfigure}
%\begin{subfigure}{0.32\linewidth}
%\centering
%\fbox{\includegraphics[height=0.5in]{./figure/mouth_contour.png}}\caption{perspective}\label{mouth_persp}
%\end{subfigure}
%\begin{subfigure}{0.45\linewidth}
%\centering
%\fbox{\includegraphics[height=0.5in]{./figure/mouth_mesh.png}}\caption{mesh}\label{mouth_mesh}
%\end{subfigure}
  \caption{mouth model creation from two open and one closed silhouette contours in three different view planes}
 \label{fig:mouth}
\end{figure}  \\
With the above method, we draw a closed palm contour and two open curves shown in Figure \ref{fig:mouth}\subref{fig:mouth_contour}. They divide the palm into four regions. One surface is created each of the four regions. Figure \ref{fig:mouth}\subref{fig:mouthmesh} depicts the palm model consisting of the four surfaces. \\
...
\centering
 \subcaptionbox{detached primitives\label{detach}}{\includegraphics[width=0.4\linewidth]{./figure/detach.png}}
  \subcaptionbox{add transition surfaces\label{attached}}{\includegraphics[width=0.4\linewidth]{./figure/attached.png}}
 \caption{Creation of smooth transition surfaces between primitives}
 \label{fig:blend}
\end{figure}  
