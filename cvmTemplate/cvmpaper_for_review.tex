...
\begin{center}
  \begin{subfigure}[!b]{0.45\linewidth}
       ...
       \includegraphics[width=0.9\linewidth]{./figure/fdmnode_a.png}
        \caption{}\label{fig:fdmnode_side}
   \end{subfigure}
   \begin{subfigure}[!b]{0.45\linewidth}
       \centering
       \includegraphics[width=0.9\linewidth]{./figure/fdmnode_b.png}
        \caption{}\label{fig:fdmnode_top}
   \end{subfigure}
\end{center}
...
\centering
 \begin{subfigure}[!t]{0.32\linewidth}
       \includegraphics[height=1in]{./figure/cylinder.png}
        \caption{}\label{fig:are_cylinder}
   \end{subfigure}
   \begin{subfigure}[!t]{0.32\linewidth}
       \includegraphics[height=1in]{./figure/deformer.png}
        \caption{}\label{fig:arm_finish}
   \end{subfigure}
