...
\begin{figure}[h!tb]
	...
	\end{center}
	\caption{Finite difference nodes for Algorithm for one open and one closed silhouette contours in two different view planes}
...
\centering
\begin{multicols}{2}
\resizebox{6.7cm}{5cm}{\includegraphics{./figure/referencebum.png}}
\resizebox{5.4cm}{5cm}{\includegraphics{./figure/buttcheck.png}}
\end{multicols}
\caption{Algorithm for two open and one closed silhouette contours in three different view planes}
\label{fig:bum}
\end{figure}
